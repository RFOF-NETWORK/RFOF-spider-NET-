...
// #--- KFR-2025 Orchestrator ---#
// Initialisiert die gesamte Seite, sobald die HTML-Struktur bereit ist.
document.addEventListener('DOMContentLoaded', () => {
    loadPageContentAndInitApp();
});

/**
 * Lädt den statischen Markdown-Inhalt und initialisiert dann die Wallet-Anwendung.
 */
async function loadPageContentAndInitApp() {
    const contentContainer = document.getElementById('content-container');
    if (!contentContainer) {
        console.error("Kritischer Fehler: #content-container nicht gefunden.");
        return;
    }
    ...
    try {
        ...
        // Für eine robuste Implementierung sollte diese im <head> der index.html geladen werden.
        contentContainer.innerHTML = typeof marked !== 'undefined' ? marked.parse(markdown) : markdown;

        // Initialisiere die Wallet-App, nachdem der Container bereit ist
        ...
        contentContainer.innerHTML = "<p>Fehler beim Laden der Inhalts-Matrix.</p>";
...
// # FUNKTION: Die vollständige Logik für die Wallet-rApp.
// #================================================
class WalletApp {
    constructor(target) {
